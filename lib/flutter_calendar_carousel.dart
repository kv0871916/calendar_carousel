...
class CalendarCarousel<T extends EventInterface> extends StatefulWidget {
  ...
  final Function(DateTime)? onLeftArrowPressed;
  final Function(DateTime)? onRightArrowPressed;
          ...
          CalendarHeader(
            ...
            onLeftButtonPressed: () {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                widget.onLeftArrowPressed?.call(!widget.weekFormat
                    ? this._dates[_pageNum]
                    : this._weeks[_pageNum][firstDayOfWeek]);
              });
            },
            onRightButtonPressed: () {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                widget.onRightArrowPressed?.call(!widget.weekFormat
                    ? this._dates[_pageNum]
                    : this._weeks[_pageNum][firstDayOfWeek]);
              });
            },
